...
parser.add_argument('--train', type=str, default="./data/BC7-LitCovid-Train+Dev.csv", help='The training input files')
...
def getCorpora(data, mode):
    ...
    for i in data.itertuples():
        ...
        # Concatenate keywords, title and abstract 
        ...
        if mode == "train":
            ...
            # For each label of the document
            for current_label in anns:

                # Enhance class specific keywords
                token_custom = re.sub(
...
# Load the test file with fake labels for dimension consistency
